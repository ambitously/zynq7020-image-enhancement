...
proc create_root_design { parentCell } {
  ...
  set touch_key [ create_bd_port -dir I touch_key ]
  ...
  connect_bd_net -net AXI_VIP_Frame_Differ_0_led [get_bd_ports led] [get_bd_pins AXI_VIP_Frame_Differ_0/led]
  ...
  connect_bd_net -net touch_key [get_bd_ports touch_key] [get_bd_pins AXI_VIP_Frame_Differ_0/touch_key]
